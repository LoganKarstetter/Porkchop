...
{
    /** Called by the game once the player has triggered the easter egg */
    ...
    /** Called by the game once the player has defeated particular special enemy */
    void specialEnemyDied();
}
